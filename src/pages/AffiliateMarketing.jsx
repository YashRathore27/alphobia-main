          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary/10 border border-secondary/20 rounded-[2px] w-fit">
                ...
                <span className="text-label-sm font-label-sm text-secondary uppercase tracking-widest">Global Reach</span>
              </div>
          ...
          <div className="border border-white/10 rounded-[2px] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 items-center">
              ...
              <div className="bg-transparent p-8 rounded-[2px] border border-white/10 flex flex-col justify-center text-center">
                ...
                <p className="text-4xl sm:text-5xl font-extrabold text-white mb-2">{formatCurrency(minReturn)} - {formatCurrency(maxReturn)}</p>
                <p className="text-white/50 text-xs italic mb-6">Based on average vertical performance benchmarks.</p>
      ...
      <section className="py-24 px-6 sm:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div onClick={() => go("case-studies")} className="group cursor-pointer space-y-4">
            ...
            <p className="text-xs font-semibold text-secondary uppercase tracking-wider">FINTECH SECTOR</p>
            <h3 className="font-bold text-xl text-primary group-hover:text-secondary transition-colors">400% Lead Volume Increase for Series C Neobank</h3>
            <p className="text-on-surface-variant text-sm">How we scaled a publisher network of 150+ high-authority finance blogs to dominate market share.</p>
          </div>
          ...
          <div onClick={() => go("case-studies")} className="group cursor-pointer space-y-4">
            ...
            <p className="text-xs font-semibold text-secondary uppercase tracking-wider">E-COMMERCE</p>
            <h3 className="font-bold text-xl text-primary group-hover:text-secondary transition-colors">Global Expansion Strategy for Luxury Apparel Brand</h3>
            <p className="text-on-surface-variant text-sm">Expanding a boutique label into 12 new European markets via local fashion influencer networks.</p>
          </div>
        </div>
      </section>
