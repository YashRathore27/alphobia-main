...
function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const percent = scrollable > 0 ? scrollY / scrollable : 0;
      setIsHidden(percent > 0.75);
    };
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200/40 transition-all duration-500 ease-in-out ${
      isHidden 
                ...
                <div className="absolute top-full left-0 mt-1 w-64 bg-white border border-slate-200 rounded-xl shadow-xl p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  >
                    <div>
                      ...
                      <p className="font-label-sm text-slate-500">Omnichannel performance growth</p>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    <div>
                      ...
                      <p className="font-label-sm text-slate-500">Global partner networks</p>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    <div>
                      ...
                      <p className="font-label-sm text-slate-500">Precision target campaign scale</p>
                    </div>
                  </button>
                </div>
              )}
