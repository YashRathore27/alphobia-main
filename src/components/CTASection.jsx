        ...
        >
          {sent ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                className="h-14 shrink-0 rounded-[2px] bg-white px-8 font-body-md font-bold text-primary hover:bg-slate-100 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
