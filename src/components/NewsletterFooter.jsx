    ...
    <section className="mx-auto max-w-7xl px-6 sm:px-8 py-16">
      <div className="bg-primary rounded-[2px] p-12 md:p-20 relative overflow-hidden text-center text-on-primary shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-8">
          <h2 className="font-display-xl leading-tight text-white">
          ...
          >
            {sent ? (
              <p className="rounded-[2px] bg-white/10 px-6 py-4 text-center font-body-md font-bold text-white backdrop-blur">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="h-14 flex-1 rounded-[2px] border border-white/20 bg-white/10 px-5 text-white outline-none placeholder:text-slate-400 focus:border-white/50 focus:ring-4 focus:ring-white/10"
                />
                <button
                  type="submit"
                  className="h-14 shrink-0 rounded-[2px] bg-white px-8 font-body-md font-bold text-primary hover:bg-slate-100 transition-all flex items-center justify-center gap-2"
                >
                  Join Now <Send className="w-4 h-4" />
                </button>
              </div>
            )}
            <p className="mt-3 font-label-sm text-white/50">
    ...
    <footer className="bg-surface dark:bg-inverse-surface border-t border-outline-variant w-full py-20 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-6 sm:px-8 max-w-7xl mx-auto">
        <div className="space-y-6">
          ...
          <p className="text-on-surface-variant font-body-md pr-6">
        ...
        <div className="space-y-6">
          ...
          <p className="text-on-surface-variant font-body-md">Join our network for high-frequency market intelligence.</p>
          <form
            className="flex"
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            {sent ? (
              <p className="font-label-sm font-semibold text-secondary">Subscribed! Check email.</p>
            ) : (
              <>
                <input
                  type="email"
                  ...
                  className="bg-white border-2 border-outline-variant/30 rounded-l-[2px] px-4 py-3 focus:border-secondary outline-none w-full text-on-surface"
                />
      ...
      <div className="mt-20 pt-10 border-t border-outline-variant/30 px-6 sm:px-8 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 opacity-60">
        <p className="font-body-md text-on-surface-variant">© 2026 Alphobia. All rights reserved. Global B2B Excellence.</p>
        <div className="flex gap-8 font-body-md text-on-surface-variant">
